...
1. 从 [Releases](https://github.com/xjtuer216/jdm/releases) 下载 `jdm-setup-*.exe`
2. 双击运行安装程序
3. 选择安装目录和 JDK 存储位置
4. 安装完成后打开新终端即可使用
...
1. 从 [Releases](https://github.com/xjtuer216/jdm/releases) 下载最新版本的 `jdm.exe`
...
| `download_mirror` | GitHub 下载代理 | `https://ghproxy.net` |
